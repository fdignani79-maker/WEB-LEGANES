...
const translations = {
    'es': {
        ...
        'contact_payment_step_label': 'Paso 1 · Evaluación inicial',
        'contact_payment_first_title': 'Evaluación inicial — el inicio de tu camino en España',
        'contact_payment_first_lead': 'Reserva tu evaluación inicial con el equipo: priorizamos jugadores que dan este paso, por la alta demanda de consultas.',
        'contact_payment_credit': 'Si continúas con un programa, los <strong>USD 29,99</strong> de esta evaluación se <strong>descontarán del precio total</strong> del programa que contrates. Así no pagas dos veces por el mismo inicio de proceso.',
        'contact_payment_notice_title': '<strong>Cómo continúas</strong>',
        'contact_payment_notice_text': 'Tras pagar en Stripe, serás redirigido a una página segura para completar la <strong>solicitud con tus datos</strong>. Sin ese paso previo no recibimos el formulario.',
        'contact_pay_cta': 'Pagar USD 29,99 y continuar',
        'contact_after_payment_hint': 'Pago seguro con Stripe; verás el resumen antes de confirmar.',
        'form_submit_status_success': 'Solicitud enviada correctamente.',
        'post_payment_page_title': 'Completa tu solicitud | Elite Futbol Scouting',
        'post_payment_page_heading': 'Solicitud de programa',
        'post_payment_form_intro': 'Has llegado aquí tras completar el pago de la evaluación inicial en Stripe. Completa el formulario y nuestro equipo te contactará para los siguientes pasos.',
        ...
        'faq_a3': 'Depende del país de origen. Ciudadanos de la UE y de muchos países de Latinoamérica pueden ingresar como turistas hasta 90 días. Para el programa de 1 año se requiere pasaporte o ciudadanía europea. Te asesoramos en cada caso.',
        ...
        'application_step1': 'Pago evaluación inicial (Stripe)',
        'application_step2': 'Solicitud con tus datos',
    ...
    'en': {
        ...
        'contact_payment_step_label': 'Step 1 · Initial evaluation',
        'contact_payment_first_title': 'Initial evaluation — the start of your path in Spain',
        'contact_payment_first_lead': 'Book your initial evaluation with our team: we prioritize players who take this step because of high inquiry volume.',
        'contact_payment_credit': 'If you move forward with a program, the <strong>USD 29.99</strong> from this evaluation will be <strong>credited toward the total program price</strong> you choose — so you are not paying twice for the same first step.',
        'contact_payment_notice_title': '<strong>How it works</strong>',
        'contact_payment_notice_text': 'After you pay on Stripe, you will be redirected to a secure page to complete the <strong>application with your details</strong>. We do not receive the form without that prior step.',
        'contact_pay_cta': 'Pay USD 29.99 and continue',
        'contact_after_payment_hint': 'Secure payment with Stripe; you will see a clear summary before you confirm.',
        'form_submit_status_success': 'Your application was submitted successfully.',
        'post_payment_page_title': 'Complete your application | Elite Futbol Scouting',
        'post_payment_page_heading': 'Program application',
        'post_payment_form_intro': 'You were redirected here after completing the initial evaluation payment in Stripe. Complete the form and our team will follow up with next steps.',
        ...
        'faq_a3': 'It depends on the country of origin. EU citizens and many Latin American countries can enter as tourists for up to 90 days. The 1-year program requires a European passport or citizenship. We advise on each case.',
        ...
        'application_step1': 'Initial evaluation payment (Stripe)',
        'application_step2': 'Application & your details',
